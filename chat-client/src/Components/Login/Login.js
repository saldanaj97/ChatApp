    ...
    return (
        <Flex className='login' flexDirection='column' mb='8'>
            ...
            <Flex className="form" gap='1rem' flexDirection={{ base: "column", md: "row" }}>
                <Input variant='flushed' mr={{ base: "0", md: "4" }} mb={{ base: "4", md: "0" }} focusBorderColor='#FA2849' type="text" placeholder='User Name' value={name} onChange={e => setName(e.target.value)} />
                <Input variant='flushed' mr={{ base: "0", md: "4" }} mb={{ base: "4", md: "0" }} focusBorderColor='#FA2849' type="text" placeholder='Room Name' value={room} onChange={e => setRoom(e.target.value)} />
